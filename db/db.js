export const bio = [
  "Hello there &#128075;",
  "I'm Vikas Yadav, MBA in IT, a tech-savvy professional adept at aligning business goals with technology solutions. With expertise in project management, system analysis, and emerging tech, I drive organizational success. ",
  "I drive organizational success. Explore my portfolio for achievements in finance, healthcare, and e-commerce. Let's connect to discuss how I can enhance your organization's growth.",
];

export const skills = [
  {
    title: "IT Strategy",
    skillName: " Developing and implementing strategic plans to align technology with business objectives.",
    color: "1",
    percentage: "85",
  },
  {
    title: "Project Management",
    skillName: "Successfully leading and delivering complex IT projects on time and within budget",
    color: "6",
    percentage: "75",
  },
  {
...
export const education = [
  {
    ...
    duration: "",
    subtitle: "Dayanand Anglo-Vedic College",
    details: [
    ...
    title: "MBA IN IT",
    duration: "2",
    subtitle: "Dayanand Academy of Management Studies",
    details: [
      "I successfully qualified GATE-2020, demonstrating my aptitude and expertise in the field.",
      "As an active competitive programmer, I have achieved a CodeChef rating of 1841*, showcasing my skills in solving complex programming problems.",
      "My GitHub projects have earned over 1k stars and forks, a testament to my ability to create high-quality and impactful code.",
...
export const footer = [
  ...
  },
  {
    ...
    data: [
      "Made with &hearts; by Vikas Yadav.",
